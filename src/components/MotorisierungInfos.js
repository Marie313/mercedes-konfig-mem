            ...
            <div className="inline">
              <div className="left">
                <input
                  ...
                  checked={motorSteps == modelsid}
                  onChange={() =>
                    collectmotor([modelsname, modelsrenperc, modelsid])
                  }
                  type="checkbox"
                />
                <h2 className="motorname">{modelsname}</h2>
                <button
                  className="infoIconButtonMotor"
                  onClick={() => showDetailBox(modelsname)}
                >
                  <img className="infoIcon" src={info} alt="info" />
                </button>
              </div>
              <div className="right">
                <h2 className="motorname">
                  Zinssatz {modelsrenperc.toFixed(2)}%
                </h2>
              </div>
            </div>
            <div className="blocks">
              ...
              <div className="blocktwo">
                ...
                <div className="inline">
                  ...
                  <p className="pmotorflex">
                    {modelsfuel?.wltp.powerConsumptionWeighted}
                  </p>
                </div>
                <div className="inline">
                  <strong className="pmotorstrong">
                    CO<sub>2</sub>-Emission gewichtet, kombiniert:
                  </strong>
                  <p className="pmotorflex">{modelsfuel?.wltp.co2Weighted}</p>
                </div>
                <div className="inline">
                  <strong className="pmotorstrong">
                    CO<sub>2</sub>-Klasse (gewichtet, kombiniert):
                  </strong>
      ...
      {models.map((models) => (
        <div>
          {infoMotor(
            ...
            models.fuelConsumption,
            models.rentalPercentage
          )}
        </div>
      ))}
      <div className="linesside">
        {isVisible && (
          <div className="displaydeatils">
            <div className="detailBoxConsumption">
              <ConsumptionLabel
